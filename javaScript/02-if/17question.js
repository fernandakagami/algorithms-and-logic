...
let sides = parseInt(readline.question("Number of Sides: "));

if (sides == 3) {
    let measure1 = parseFloat(readline.question("Measure of side 1: "));
    let measure2 = parseFloat(readline.question("Measure of side 2: "));
    let measure3 = parseFloat(readline.question("Measure of side 3: "));   
    console.log(`Triangle and its perimeter is ${measure1 + measure2 + measure3}.`);    
} else if (sides == 4) {
    let measure1 = parseFloat(readline.question("Measure of side 1: "));
    let measure2 = parseFloat(readline.question("Measure of side 2: "));
    let measure3 = parseFloat(readline.question("Measure of side 3: "));
    let measure4 = parseFloat(readline.question("Measure of side 4: "));
